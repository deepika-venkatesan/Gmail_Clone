    ...
    <div id="EmailView" class="bg-gray-50 h-screen">
        <div class="flex items-center p-2">
            <div class="logo-section flex justify-start items-center px-3.5">
                ...
                <img width="107" src="../../../public/img/logogmail.png" alt="Gmail Logo">
            </div>
        ...
        <div class="flex w-full justify-between">
            ...
            <div class="m-4">
                <div class="w-6 h-6 flex justify-center mb-7">
                    <img class="object-center" src="img/gcal.png" alt="">
                </div>
                ...
                <div class="w-6 h-6 flex justify-center mb-7">
                    <img class="object-center" src="img/gtasks.png" alt="">
                </div>
                ...
                <div class="w-6 h-6 flex justify-center mb-7"></div>
                    <PlusIcon />
                </div>
...
#EmailView {
  ...
  .side-menu {
    width: 300px; /* Adjust side menu width */
  }
